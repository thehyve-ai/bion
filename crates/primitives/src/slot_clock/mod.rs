// This file contains code adapted from the Lighthouse project,
// which is licensed under the Apache 2.0 License.
// Copyright © 2018-2024 Sigma Prime Pty Ltd.
//
// You can view the original Lighthouse code here:
// https://github.com/sigp/lighthouse/tree/stable/common/slot_clock

// As we are "rolling up" to Ethereum, it makes sense to keep track of the same slot clock, but with
